...
public class KeyHandler {
	...
	public void onKeyInput(KeyInputEvent event) {
		...
		// if (modifier != null) {
		// Plato.network.sendToServer(new ModifierMessage(modifier, Keyboard.getEventKeyState()));
		// }
		//
		...
		// case UNDO:
		// try {
		// // Method isPressed is client side only.
		// // Modifiers.isPressed(Modifier) to be used on server side in staffs and spells
